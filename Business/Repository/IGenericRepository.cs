...
namespace Business.Repository
{
    public interface IGenericRepository<TEntity> where TEntity : class
    {
        ...
        GenericRepository<TEntity> ThenInclude<TPrevious, TProperty>(Expression<Func<TPrevious, TProperty>> navigationProperty);
        ...
        GenericRepository<TEntity> FilterEqualsByColumn(string columnPath, object value);
