...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260917091754_Migration_18_BackfillAttendanceSnapshots")]
    partial class Migration_18_BackfillAttendanceSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.TrainGroupParticipant", b =>
                {
                    ...
                    b.Property<DateTime?>("RecurringStartOnDate")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Core.Models.TrainGroupΑttendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("TrainGroupDescription")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("TrainGroupDuration")
                        .HasColumnType("TEXT");

                    b.Property<int?>("TrainGroupId")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime>("TrainGroupStartOn")
                        .HasColumnType("TEXT");

                    b.Property<string>("TrainGroupTitle")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("TrainGroupΑttendances");
                });
            ...
            modelBuilder.Entity("Core.Models.TrainGroupΑttendance", b =>
                {
                    b.HasOne("Core.Models.TrainGroup", "TrainGroup")
                        .WithMany("TrainGroupΑttendances")
                        .HasForeignKey("TrainGroupId")
            ...
            modelBuilder.Entity("Core.Models.TrainGroup", b =>
                {
                    ...
                    b.Navigation("TrainGroupΑttendances");
                });
