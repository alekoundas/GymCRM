        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TrainGroupDateType = table.Column<string>(type: "TEXT", nullable: false),
                    FixedDay = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "TrainGroupUnavailableDates",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainGroupUnavailableDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainGroupUnavailableDates_TrainGroups_TrainGroupId",
                        column: x => x.TrainGroupId,
                        principalTable: "TrainGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainGroupParticipantUnavailableDates", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainGroupUnavailableDates_Id",
                table: "TrainGroupUnavailableDates",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainGroupUnavailableDates_TrainGroupId",
                table: "TrainGroupUnavailableDates",
                column: "TrainGroupId");
